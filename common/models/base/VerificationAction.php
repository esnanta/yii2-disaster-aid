...
class VerificationAction extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\VerificationActionQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\query\VerificationActionQuery(get_called_class());
